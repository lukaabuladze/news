...
export default function ({posts, title}) {
  ...
  return (
    <>
      {
        posts?.length > 0 && (
          <section className="top-store-post-area pt-60 pb-40 fix" style={{background: '#f3f8fb'}}>
                  ...
                  <div className="row">
                    ...
                    <div className="col-lg-8">
                      <div className="section-title text-right mt-10">
                        <Link to={`#`}>სრულად <i className="fal fa-long-arrow-right" /></Link>
                      </div>
                    </div>
                  </div>
                  <div className="row ">
                    {
                      posts?.map((item, key) => {
                        return  (
                          <div className="col-lg-4 col-md-12 align-items-stretch" key={key}>
